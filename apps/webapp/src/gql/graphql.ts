...
export type CreateEventInput = {
  ...
  end_time: Scalars['Timestamp']['input'];
  ...
  start_time: Scalars['Timestamp']['input'];
...
export type GetEventDetailsQuery = { __typename?: 'Query', event?: { __typename?: 'Event', id: string, name: string, tagline?: string | null, banner_url?: string | null, logo_url?: string | null, updated_at?: number | null, start_time: number, end_time: number, timezone: string, address: string, city: string, created_at?: number | null, created_by: { __typename?: 'User', id: string, first_name?: string | null, last_name?: string | null, avatar_url?: string | null } } | null };
...
export type GetEvents_EventsFragment = { __typename?: 'Event', id: string, name: string, tagline?: string | null, banner_url?: string | null, logo_url?: string | null, start_time: number, end_time: number, address: string, city: string, timezone: string } & { ' $fragmentName'?: 'GetEvents_EventsFragment' };
