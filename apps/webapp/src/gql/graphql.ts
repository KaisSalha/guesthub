...
export type GetOrgRoles_RolesFragment = { __typename?: 'Role', id: string, name: string, permissions: any } & { ' $fragmentName'?: 'GetOrgRoles_RolesFragment' };
